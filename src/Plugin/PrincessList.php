...
class PrincessList {
  ...
  public function __construct() {
    ...
    $this->plOffset = $this->princessDbConnection->select('princess_list', 'pl')
  ...
  public function cron() {
    ...
    if ($this->princessReload) {
      $pl_data = json_decode($this->plEnd);
      ...
      if (!empty($dds_service_members)) {
        ...
        $pl_data['users'] = $service_members;
      }
      // Populate the groups.
      if (!empty($dds_service_group)) {
        $dept_list = [];
